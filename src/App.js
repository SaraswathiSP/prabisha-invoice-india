      ...
      <Document>
        <Page size="A4" style={styles.page}>
          <View style={styles.topSection}>
            ...
            <View style={styles.address}>
              ...
              <Text style={styles.addInfo}>
                D4/4029, Vasant Kunj, New Delhi,
              </Text>
              <Text style={styles.addInfo}>India - 110 070</Text>
              <Text style={styles.addInfo}>www.prabisha.com</Text>
              <Text style={styles.addInfo}>info@prabisha.com</Text>
            </View>
          </View>
          ...
          <View style={styles.table}>
            <View style={styles.row1}>
              ...
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={{ fontSize: 13, width: 100, marginRight: 9 }}>
                  Net Price(INR)
                </Text>
              </View>
            </View>
            ...
            <View style={styles.row3}>
              <Text style={{ fontWeight: 1000, fontSize: 12, marginRight: 10 }}>
                TOTAL
              </Text>
          ...
          <View style={styles.fourthSection}>
            ...
            <Text style={styles.info}>Prabisha Pvt.Ltd.</Text>

            <Text style={styles.info}>Current A/c No : 2213812876</Text>
            <Text style={styles.info}>IFSC : KKBK0004597</Text>
            <Text>{"   "}</Text>
            <Text style={styles.info}>Thank you for your interst.</Text>
            ...
            <Text style={styles.info}>www.prabisha.com</Text>
          </View>
        </Page>
      </Document>
    );
    ...
    <div className="container">
      <div className="company-details">
        ...
        <div className="company-address">
          ...
          <p className="addInfo">D4/4029,Vasant Kunj, New Delhi,</p>
          <p className="addInfo">India - 110 070</p>
          <p className="addInfo">www.prabisha.com</p>
          <p className="addInfo">Email:info@gmail.com</p>
        </div>
      </div>
      <hr className="line" />
